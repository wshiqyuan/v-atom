...
<demo vue="../demo/select/Basic.vue" title="基础选择器" description="Select 基础选择器" />
...
<demo vue="../demo/select/Clear.vue" title="可清空单选" description="Select 可清空单选" />

## 自定义模板

你可以自定义如何来渲染每一个选项, 使用 `renderLabel` 属性，它接受一个回调函数，返回 vNode 类型。

<demo vue="../demo/select/CustomRender.vue" title="自定义模板" description="Select 自定义模板" />
...
<demo vue="../demo/select/Filter.vue" title="筛选选项" description="Select 筛选选项" />
...
<demo vue="../demo/select/Remote.vue" title="筛选选项" description="Select 筛选选项" />
